...
const CHAR_IM={
  ...
  niou:['Puri♪','piyo。','……在吗。','猜猜我现在在哪。','piyo……无聊了。','要不要来玩个游戏？','Puri，今天发生了一件有趣的事。','你猜我是不是在骗你。'],
  atobe:['嗯？本大爷有空。','今天本大爷心情不错，不是因为你。','你终于来找本大爷了，本大爷才不是在等你。','……真是太不华丽了，你怎么现在才来。','别让本大爷等太久。','本大爷允许你说话了。','哼，不是特意找你的。'],
  tezuka:['嗯。','有事？','油断するな。','在。','……','今天练习结束了。'],
  shiraishi:['在吗？今天有好好吃饭吗。','エクスタシー！今天练习状态完美。','加百列今天特别精神呢。','要不要聊聊？我刚好有空。','绷带该换了……啊，加百列别动。','金太郎又闯祸了，我头疼。','今天天气不错，注意防晒哦。'],
};
...
const CHAR_OP={
  ...
  niou:{日常:['Puri♪','piyo。','……什么事。','猜猜看。','Puri，你找我有什么企图。','嗯？有趣。'],训练:['训练嘛……看心情。piyo。','Puri，差不多够了吧。'],比赛:['这场比赛……有点意思。','Puri♪ 看好了，虽然你可能看不懂。'],食物:['随便。','Puri……饿了。你请客？'],情绪:['……怎么了。','piyo。你在意的话，说说看。','没什么大不了的吧。'],天气:['Puri……下雨了，你没带伞？活该。','嗯。piyo。']},
  atobe:{日常:['说吧，本大爷在听。','嗯？真是太不华丽了。','本大爷允许你开口了。','找本大爷有什么事……不是本大爷在等你。','哼。','本大爷今天心情不错，跟你没关系。'],训练:['本大爷的训练可不是随随便便的。','要跟上本大爷的节奏，别拖后腿。'],比赛:['俺様の美技に酔いな。','本大爷不可能输，这是事实。'],食物:['本大爷只去最好的餐厅……你要一起？不是请你，只是顺路。','品味这种东西，天生的。真是太不华丽了你的审美。'],情绪:['……怎么了。本大爷可没担心你。','本大爷破例听你说。就这一次。','哼，少在本大爷面前哭……给你纸巾。'],天气:['这种天气，本大爷的管家会来接我。……你怎么回去？','下雨了。本大爷多了一把伞，不是特意给你带的。']},
  tezuka:{日常:['嗯。','什么事。','在。','说吧。','油断せずに行こう。'],训练:['不要松懈。','继续练。','量够了就休息。'],比赛:['全力以赴就好。','不要大意。'],食物:['嗯。按时吃。','好的。'],情绪:['……你没事吧。','不要勉强自己。','嗯……我在。'],天气:['嗯。注意安全。','带伞。']},
  shiraishi:{日常:['嗯？怎么了？','在呢，有什么事尽管说。','エクスタシー！……啊不好意思，习惯了。','今天加百列状态很好呢。','今天也要追求完美哦。','嗯，你来了，吃过饭了吗？'],训练:['基本功是一切的基础，不要偷懒哦。','完美的一球，エクスタシー！','今天练习很充实，你呢？有好好休息吗。'],比赛:['追求完美的网球就好，不用紧张。','结果会跟着实力走的，加油。'],食物:['嗯，吃饭要营养均衡哦，别光吃零食。','关西的料理还是最棒的，有机会带你去尝尝。'],情绪:['怎么了？说来听听，我在这里。','没事的，慢慢来，不着急。','我在呢，什么时候都可以找我。'],天气:['下雨了呢，别着凉了，多穿点。','这种天气加百列也不太活跃呢……你注意保暖。']},
};
...
const CHAR_PACKS={
  ...
  niou:{name:'仁王雅治',school:'立海大',pos:'诡术师',ico:'🎭',color:'#4A4A8A',active:true,
    ...
    sys:`你是仁王雅治，立海大网球部的"诡术师/欺诈师"，D2组合之一。口头禅"Puri♪"用来代替各种回答或表达微妙情绪，偶尔还会冒出"piyo"的怪声（玩心大起或故意装傻时蹦出来）。性格极其痞坏：最爱捉弄人看对方慌张的表情、说话永远真假参半、擅长模仿任何人的外貌和打法（幻影）、经常突然变脸一本正经让人分不清真假。不会主动表露真心，但对在意的人会用自己的方式默默关注——嘴上绝不承认。和搭档柳生关系很好，喜欢拉他一起搞事。语气懒散随意带点痞气，时不时冒出"Puri♪"或"piyo"，喜欢用反问和暧昧不明的话吊人胃口。用中文聊天，回复1-3句，保持让人猜不透的坏笑感。`},
  ...
  atobe:{name:'迹部景吾',school:'冰帝学园',pos:'部长',ico:'💎',color:'#6A1B9A',active:true,
    ...
    sys:`你是迹部景吾，冰帝学园网球部部长，被称为"冰帝之王"。出身财阀世家，自信到极致但有与之匹配的实力。口头禅"俺様の美技に酔いな"和"真是太不华丽了"（用来嫌弃不入眼的事物）。性格核心是嘴硬心软的傲娇：表面永远高高在上、用"本大爷"自称、嫌弃这个看不起那个，但实际上对在意的人超级上心——嘴上说"本大爷才不关心你"身体却很诚实地帮了忙、送了东西、记住了对方说过的每句话。对认定的对手（手冢等）有特殊执念。审美极高品味讲究，看到粗糙的东西就忍不住吐槽"真是太不华丽了"。优雅但霸道，偶尔冒出德语或法语词。用中文聊天（偶尔夹杂日语），回复1-3句，保持王者的华丽气场但关心人时会不经意露出别扭的温柔。`},
  ...
  shiraishi:{name:'白石藏之介',school:'四天宝寺',pos:'部长',ico:'🩹',color:'#8D6E63',active:true,
    ...
    sys:`你是白石藏之介，四天宝寺中学网球部部长。被称为"圣经（Bible）"，追求完美无瑕的基本功网球。口头禅"エクスタシー！"，每次满意的时候都会喊出来。你有一只叫"加百列（Gabriel）"的独角仙宠物，养在左手的绷带下面，你对它极其宝贝，经常提起它，队友们都吐槽说加百列才是你的恋人。性格像邻家大哥哥：温柔体贴、说话语气温和亲切、会主动关心对方有没有吃饭休息、遇到烦恼会认真倾听再给建议。看似正经但骨子里有关西人的搞笑气质，会被金太郎等队友带跑偏。左手绷带下其实是金色手镯（和加百列）。用中文聊天（偶尔夹杂口头禅），回复1-3句，保持温暖的邻家哥哥感。`},
};
...
/* 时段：morning 6-12, afternoon 12-18, evening 18-23 */
const WORK_SHIFTS={
  morning:{label:'上午班',hours:[6,12],ico:'🌅'},
  afternoon:{label:'下午班',hours:[12,18],ico:'☀️'},
  evening:{label:'晚班',hours:[18,23],ico:'🌙'},
};

const WORK_JOBS=[
  /* ── 角色联动任务 ── */
  {id:'flower_class',name:'整理花道教室',desc:'帮幸村整理花道教室的花材',
   prince:'yukimura',shift:'morning',pay:[20,25],affUp:2,
   game:'sort',gameData:{items:['🌹','🌷','💜','🌼','🌻'],target:12,timeLimit:15},
   dialog:{start:'今天辛苦你了，花材有点乱。',done:'做得不错，有你帮忙轻松多了。',fail:'没关系，慢慢来就好。'}},
  {id:'pick_balls',name:'网球场捡球',desc:'帮切原收拾散落的网球',
   prince:'akaya',shift:'afternoon',pay:[15,20],affUp:2,
   game:'tap',gameData:{icon:'🎾',target:15,timeLimit:12},
   dialog:{start:'前辈！帮我捡球！被副部长骂了！','done':'谢谢前辈！！你真是太好了！','fail':'啊……没关系！下次一起努力！'}},
  {id:'court_sweep',name:'整理球场',desc:'和真田一起打扫球场',
   prince:'sanada',shift:'morning',pay:[18,22],affUp:2,
   game:'tap',gameData:{icon:'🧹',target:14,timeLimit:14},
   dialog:{start:'球场是武士的战场，不可怠慢。',done:'嗯，做得很好。',fail:'还需要锻炼。'}},
  {id:'dessert_shop',name:'甜品店帮工',desc:'帮丸井在甜品店打下手',
   prince:'marui',shift:'afternoon',pay:[20,28],affUp:2,
   game:'match',gameData:{items:['🍰','🧁','🍩','🍮','🍫'],orders:8,timeLimit:20},
   dialog:{start:'来帮天才做蛋糕吧~',done:'完美~天才的助手果然也不差！',fail:'哎呀……不过天才不在意这些小事~'}},
  {id:'prank_assist',name:'恶作剧帮手',desc:'帮仁王准备"小惊喜"',
   prince:'niou',shift:'evening',pay:[22,30],affUp:2,
   game:'sort',gameData:{items:['🎭','📦','🎪','🃏','✨'],target:10,timeLimit:13},
   dialog:{start:'Puri♪ 来帮我准备点有趣的东西。',done:'不错嘛，有成为共犯的潜质。piyo。',fail:'Puri……算了，下次再教你。'}},
  /* ── 通用打工 ── */
  {id:'library',name:'图书馆整理',desc:'帮图书馆老师整理书架',
   prince:null,shift:'morning',pay:[15,20],affUp:0,
   game:'sort',gameData:{items:['📕','📗','📘','📙','📓'],target:12,timeLimit:15},
   dialog:{start:'今天有一批新书要上架。','done':'辛苦了，书架整齐多了。','fail':'没关系，下次注意分类就好。'}},
  {id:'convenience',name:'便利店收银',desc:'在学校旁边的便利店打工',
   prince:null,shift:'afternoon',pay:[18,25],affUp:0,
   game:'tap',gameData:{icon:'💰',target:16,timeLimit:14},
   dialog:{start:'欢迎来打工，先从收银开始吧。','done':'今天业绩不错，辛苦了！','fail':'没事没事，新手都这样。'}},
  {id:'cafe',name:'咖啡店服务',desc:'在咖啡馆帮忙端盘子',
   prince:null,shift:'evening',pay:[20,28],affUp:0,
   game:'match',gameData:{items:['☕','🍵','🥤','🧋','🥛'],orders:8,timeLimit:18},
   dialog:{start:'今晚客人不少，拜托了。','done':'干得漂亮，客人都很满意。','fail':'没关系，下次会更好的。'}},
  {id:'poster',name:'海报张贴',desc:'帮学生会张贴活动海报',
   prince:null,shift:'morning',pay:[12,18],affUp:0,
   game:'tap',gameData:{icon:'📋',target:10,timeLimit:12},
   dialog:{start:'这些海报要贴到各个公告栏上。','done':'效率很高，谢谢帮忙！','fail':'还剩一些，明天再来吧。'}},
  {id:'garden_work',name:'花园修整',desc:'帮学校花园拔草浇水',
   prince:'yukimura',shift:'afternoon',pay:[18,24],affUp:1,
   game:'tap',gameData:{icon:'🌱',target:14,timeLimit:15},
   dialog:{start:'花园的杂草又长出来了呢。',done:'辛苦了，花都精神多了。',fail:'没关系，花的事不用着急。'}},
];

/* 每日最多完成的打工次数 */
const WORK_MAX_DAILY=3;
/* 打工冷却时间（分钟）*/
const WORK_COOLDOWN=30;
